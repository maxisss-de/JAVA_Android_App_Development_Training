//========================================================================
// Программа для размена монет с помощью ОДНОГО ЦИКЛА
//========================================================================
...
public class Main {
    ...
    static void razmen(int summa){  // Метод рассчитывающий сколько монет насыпать
        ...
        while (summa >= 1) {
            if (summa/10>=1) {
                System.out.println("Примите десяточку - 10 рублей");   summa-=10;
            }
            else if (summa/5>=1) {
                System.out.println("Примите пятачок - 5 рублей");    summa-=5;
            }
            else if (summa/2>=1) {
                System.out.println("Примите двушечку - 2 рублей");    summa-=2;
            }
            else if (summa/1>=1) {
                System.out.println("Примите рублик - 1 рублей");    summa-=1;
            }
        }
